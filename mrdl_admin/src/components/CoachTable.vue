    ...
    <div class="header">
      ...
      <div class="input-find-one">
        <div class="flexing">
          ...
          <div class="forms" style="margin-right: 20px; margin-block-start: 2.80em;
   ">
            <q-input
              class="zip-input"
              dark
...
export default {
  ...
  methods: {
    ...
    searchEmail(){
      this.$store.dispatch("searchUserByEmail", {mymail:this.mymail, role:this.$route.params.module})
      this.mymail = "";
    }
  }
};
