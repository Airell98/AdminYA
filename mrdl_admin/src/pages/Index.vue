    ...
    <div class="theBody" style="max-width: 800px; margin:auto;">
      ...
      <div class="my-inputs">
        ...
        <div class="forms" style="margin-left: 25px;">
          <q-input  dark 
             bg-color="grey" outlined v-model="videoData.name" label="Video Name" dense />
        </div>
        </div>
        ...
        <div class="forms" style="margin-left: 23px;">
         <q-input  dark 
             bg-color="grey" outlined v-model="videoData.video_link" label="Video Link" dense />
        </div>
        </div>
      ...
      <!-- <div class="all-inputs">
       ...
       <div style="margin-top: 20px; width:100px; margin: auto;" >
            ...
            <q-btn class="glossy" rounded color="negative" label="Create" :disabled="isDisabled" @click="createVideo" />
            </div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed:{
    isDisabled(){
        if(this.videoData.name == null ||
        this.videoData.video_link == null || this.videoData.ModuleId == null || this.videoData.part == null|| this.videoData.desc == null||
        this.videoData.username === '' || this.videoData.video_link == '' || this.videoData.ModuleId == '' || this.videoData.part == ''||
        this.videoData.desc == '') {
          return true
        }else{
          return false
  ...
  methods:{
    createVideo(){
      ...
      axios({
        url:`${this.$store.state.baseURIVideo}`,
        method: "POST",
        data,
        headers:{
